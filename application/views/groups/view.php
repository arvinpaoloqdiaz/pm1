...
<div class="col-md-9 col-lg-10 main-content p-5 d-flex justify-content-center align-items-center flex-column">
	<h1 class="poppins mb-2 text-brand align-self-start"><?= $group->name?></h1>
	<p class="align-self-start mb-4"><?= $group->description?></p>
	<hr>
	...
	<div class="card rounded-3 hoverable border-0 mb-4 border-brand">
		<div class="card-header bg-transparent border-bottom-0 text-center h1 jetbrains-mono pt-3">
			<?= $project->name; ?>
		</div>
		<div class="card-body text-center pt-3 pb-4">
			<p class="mb-0 pb-0 display-1 poppins fw-bolder text-brand"><?= $project->status; ?></p>
		</div>
		<div class="card-footer bg-transparent border-top-0 p-0">
			
			<a class="btn btn-brand m-0 w-100 rounded-top-0 rounded-bottom-3 btn-lg" href="<?= site_url('project/view/'.$project->id) ?>">View Projects</a>
